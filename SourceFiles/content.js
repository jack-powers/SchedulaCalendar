...
chrome.runtime.onMessage.addListener(
  function (request, sender, sendResponse) {
    ...
    if (request.method == "outlook") { 
      var place = "outlook"
      // var url = "https://outlook.live.com/calendar/0/deeplink/compose?allday=false&body=" + message + "" + "&enddt=" + 2022-02-11T07%3A45%3A00%2B00%3A00&location=" + "&path=%2Fcalendar%2Faction%2Fcompose&rru=addevent&startdt="2022-02-11T05%3A15%3A00%2B00%3A00"&subject=" + matchName
      // // https://outlook.live.com/calendar/0/deeplink/compose?allday=false&body=DESC&enddt=2022-02-11T07%3A45%3A00%2B00%3A00&location=LOCATION&path=%2Fcalendar%2Faction%2Fcompose&rru=addevent&startdt=2022-02-11T05%3A15%3A00%2B00%3A00&subject=TITLE
    }
    if (request.method == "outlookOnline") {
      var place = "outlookOnline"



     }
    if (request.method == "office") { 
      var place = "office"

      // https://outlook.office.com/calendar/0/deeplink/compose?allday=false&body=DESC&enddt=2022-02-11T07%3A45%3A00%2B00%3A00&location=LOCATION&path=%2Fcalendar%2Faction%2Fcompose&rru=addevent&startdt=2022-02-11T05%3A15%3A00%2B00%3A00&subject=TITLE
    ...
    sendResponse({ text: "SENT", method: place }); //same as innerText
